...
document.addEventListener('DOMContentLoaded', async () => {
    try {
        ...
        alert('Erro ao carregar dados. Por favor, recarregue a página ou entre em contato com o suporte.');
    }
});
...
async function addUser(user) {
    try {
        ...
        showAdminPasswordModal(async (adminPassword) => {
            ...
            try {
                ...
                if (!currentUser || currentUser.role !== 'admin') {
                    console.error('Não estamos mais logados como admin após criar usuário');
                    ...
                    try {
                        ...
                        alert('Você foi desconectado. Por favor, faça login novamente como administrador.');
                        window.location.href = 'index.html';
                        return;
                    }
                }
...
function showAdminPasswordModal(onConfirm, onCancel) {
    ...
    const confirmHandler = () => {
        ...
        const modalContent = adminPasswordModal.querySelector('.confirm-modal-content');
...
async function deleteUserData(userId) {
    try {
        ...
        const deleteBtn = document.querySelector(`.user-card .delete[data-id="${userId}"]`);
        if (deleteBtn) {
...
function createUserElement(user) {
    ...
    deleteBtn.addEventListener('click', () => {
        showConfirmModal(`Tem certeza que deseja excluir o usuário "${user.name}"?`, () => {
...
function addPasswordToggle() {
    ...
    toggleButton.addEventListener('click', () => {
        if (passwordField.type === 'password') {
            ...
            toggleButton.innerHTML = '<span class="material-symbols-outlined">visibility_off</span>';
        } else {
...
function setupEventListeners() {
    ...
    userForm.addEventListener('submit', (e) => {
        ...
        if (!formNameInput || !formEmailInput || !formPasswordInput || !formRoleInput) {
            ...
            alert('Erro ao ler os dados do formulário. Por favor, recarregue a página.');
            return;
        }
    ...
    const authCheckInterval = setInterval(async () => {
        try {
            ...
            if (user.role !== 'admin') {
                ...
                clearInterval(authCheckInterval);
                alert('Você não tem mais permissão de administrador. Redirecionando para o dashboard.');
                window.location.href = 'dashboard.html';
                return;
            }
